...
DROP TABLE IF EXISTS daycareProfile CASCADE;
...
CREATE TABLE children (
  ...
  guardianID INTEGER REFERENCES guardian(id) ON DELETE CASCADE
);
...
CREATE TABLE enrolment (
  ...
  daycareID INTEGER REFERENCES daycare(id) ON DELETE CASCADE
);
